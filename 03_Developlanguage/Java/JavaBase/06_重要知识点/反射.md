...
| 方法名                | 说明                                                                                                         |
| ------------------ | ---------------------------------------------------------------------------------------------------------- |
| forName()          | (1)获取Class对象的一个引用，但引用的类还没有加载(该类的第一个对象没有生成)就加载了这个类。(2) 为了产生 Class 引用，forName () 立即就进行了初始化。                  |
...
![[09_Attachments/Java/JavaBase/06_重要知识点/Java_06_008.png]]
...
![[09_Attachments/Java/JavaBase/06_重要知识点/Java_06_009.png]]
...
![[09_Attachments/Java/JavaBase/06_重要知识点/Java_06_010.png]]
...
![[09_Attachments/Java/JavaBase/06_重要知识点/Java_06_011.png]]
...
![[09_Attachments/Java/JavaBase/06_重要知识点/Java_06_012.png]]
...
![[09_Attachments/Java/JavaBase/06_重要知识点/Java_06_013.png]]
